...
typedef enum {
    APP_INDICATOR_STATE_WAITING_UNBOUND = 0,
    APP_INDICATOR_STATE_WAITING_BOUND = 1,
    APP_INDICATOR_STATE_WAITING = 1,
    APP_INDICATOR_STATE_CONNECTING = 2,
    APP_INDICATOR_STATE_CONNECTED = 3,
    APP_INDICATOR_STATE_RADIO_ERROR = 4,
    APP_INDICATOR_STATE_BINDING_CLEARED = 5
