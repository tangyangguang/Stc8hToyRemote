...
int main(void)
{
    ...
    expect_angle(0u, 0u, APP_CONFIG_DEFAULT_STEERING_TRIM,
                 APP_CONFIG_DEFAULT_STEERING_DEADBAND, APP_CONFIG_DEFAULT_STEERING_REDUCE, 0u);
    ...
    expect_angle(180u, 0u, APP_CONFIG_DEFAULT_STEERING_TRIM,
                 APP_CONFIG_DEFAULT_STEERING_DEADBAND, APP_CONFIG_DEFAULT_STEERING_REDUCE, 180u);
